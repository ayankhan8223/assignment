...
const featurListLis = Array.from(
  document.querySelectorAll(".features__list li")
);
const featurListLisActives = Array.from(
  document.querySelectorAll(".features__list li.active")
);
const featurTaps = Array.from(document.querySelectorAll(".features__feature"));
const featurTapsActives = Array.from(
  document.querySelectorAll(".features__feature.active")
);
...
(function tapsActive() {
  ...
  featurListLis.forEach((listLi) => {
    ...
    listLi.addEventListener("click", () => {
      ...
      removeActiveClass(
        Array.from(listLi.parentElement.querySelectorAll("li.active"))
      );
      removeActiveClass(
        Array.from(
          listLi.parentElement.parentElement.querySelectorAll(
